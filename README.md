...
1. **Фиксированные услуги** — сборка из атомов, прайс-матрицы, производственные документы  
2. **Гибридные** — фикс-база + переменная часть  
3. **% от результата** — после гибрида  
4. **Комплексы и Bitrix** — после утверждения первых услуг  
